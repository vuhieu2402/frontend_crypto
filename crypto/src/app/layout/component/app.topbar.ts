...
import { UserItem } from '../../shared/model/user-item';
import { session_variables } from '../../shared/constant/variables';
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, MenuModule, ButtonModule, ConfirmDialogModule, TooltipModule, ToolbarModule, AvatarModule],
    ...
    template: ` <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                ...
                <p-confirmDialog [style]="{ width: '40dvw' }"></p-confirmDialog>
                <p-menu #menu [model]="items" [popup]="true"></p-menu>
                <a class="flex items-center align-items-center justify-content gap-2" (click)="menu.toggle($event)">
                    <span class="image-text">Hi, </span>
                    <p-avatar class="border-2" [image]="d_avt" shape="circle" [style]="{ width: '32px', height: '32px' }" />
                </a>
            </div>
        </div>
    </div>`
...
export class AppTopbar implements OnInit {
    ...
    ngOnInit(): void {
        const user_info = sessionStorage.getItem(session_variables.USER);
        if (user_info) {
